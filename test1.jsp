...
<form action="sturegister.jsp" style="border:1px solid #ccc">
  <div class="container" class='setwhite'>
    ...
    <label for='sapassword' class='setg'><b>Enter the alternate password<br>(in case you forget your password, we use this to recover your account)</b></label><br>
    <input type="password" placeholder="Enter alternate password" name="sapassword" required><br>
