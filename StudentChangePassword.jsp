<html>
<head>
	<title>Change Password | The Learning Splice</title>
</head>
...
<br>
<br>
<form action="checkstudentchangepassword.jsp">
    ...
    <div class="container">
        ...
        <label for="psw" class="setf"><b>Existing Password:</b></label><br>
      <input type="password" placeholder="Enter Password" name="psw" required><br>
      
      <label for="newpass" class="setf"><b> New Password:</b></label><br>
