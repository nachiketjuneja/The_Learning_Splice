<html>
<head>
	<title>Admin Dashboard | The Learning Splice</title>
</head>
...
<tr align=center bgcolor=brown class=setwhite>
    <td class="linktheme"><a href="AdminPStudent.jsp"> Premium Student Requests </td></a>
...
<tr align=center bgcolor=brown class=setwhite>
    <td class="linktheme"><a href="AdminPTutor.jsp"> Premium Tutor Requests </a></td>
</tr>


<tr align=center bgcolor=brown class=setwhite>
    <td class="linktheme"><a href="setnull.jsp"> Sign out! </a></td>
