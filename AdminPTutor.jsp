...
<table border="1" cellpadding="5" cellspacing="5">
    <tr class="rowback">
        ...
        <td class="setg">QUALIFICATION PROOF</td>
        <td class="setg">EXPERIENCE PROOF</td>
...
<%
    ...
    Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/thelearningsplice","root","root");
            PreparedStatement   st=connection.prepareStatement("select * from premiumtutor");
...
<tr>
    ...
    <td class="setg"><%=rs.getBlob("qualification")%></td>
    <td class="setg"><%=rs.getBlob("experience")%></td>
...
%>
    ...
    <br><br>
        ...
        <div id="container">
            <div>
        <form action="approvepremiumtutor.jsp">
                <label for="apptut" class="setwhite"><b>Enter the username of the tutor you wish to accept the request.</b></label><br>
        <input type="text" placeholder="Enter Username" name="apptut" required><br>
