<html>
<head>
	<title>User Login | The Learning Splice</title>
</head>
...
<div id="container">
    <div id="left">
<form action="checkstudentlogin.jsp">
    <h1 class="seth"><u>STUDENT LOGIN<u></h1><br><br>
    <div class="imgcontainer">
        <img src="images/student.jpg" alt="Avatar" width="450px" height="250px" align="center">
    </div>

    
    <div class="container">
        
        <label for="uname" class="set15"><b>Username:</b></label><br>
        <input type="text" placeholder="Enter Username" name="uname" required><br>

        <label for="psw" class="set15"><b>Password:</b></label><br>
      <input type="password" placeholder="Enter Password" name="psw" required><br>
      
      <label class="setwhite">
          <input type="checkbox" checked="checked" name="remember"> Remember me<br>
      </label>
      <button type="submit" class="set15">Login</button><br>
    </div>

    <div class="container">
        <button type="reset" class="cancelbtn">Reset</button><br>
        <label class="set15"><a href="SForgotPassword.jsp">Forgot password?</a></label><br>
        <label class="set15"><a href="NewStudent.jsp">New to our website? Don't worry. Register yourself here!</a></label><br>
    ...
    <div id="middle"></div>
    <div id="right">
<form action="checktutorlogin.jsp">
    <h1 class="seth"><u>TUTOR LOGIN<u></h1><br><br>
    <div class="imgcontainer">
        <img src="images/transt.png" alt="Avatar" width="450px" height="250px">
    </div>
    ...
    <div class="container">
      ...
      <button type="submit" class="set15">Login</button><br>
       ...
       <div class="container">
       <button type="reset" class="cancelbtn">Reset</button><br>
       <label class="set15"><a href="TForgotPassword.jsp">Forgot password?</a></label><br>
       <label class="set15"><a href="NewTutor.jsp">New to our website? Don't worry. Register yourself here!</a></label><br>
