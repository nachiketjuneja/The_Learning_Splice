<html>
<head>
	<title>Tutor Profile | The Learning Splice</title>
</head>
...
<table>
<%
    String tutorname=(String)session.getAttribute("tusername");
...
<br><br>
 <div class="card">
  <img src="images/tut.png" alt="John" width="300px" height="300px">
  <h1 class="seth"><%=rs.getString("firstname")%> <%=rs.getString("lastname")%></h1>
  <p class="title">Username: <%=rs.getString("username")%></p>
  <p class="seta">City: <%=rs.getString("city")%></p>
  <p class="seta">Qualification: <%=rs.getString("qualification")%></p>
  <p class="seta">Subjects Interested: <%=rs.getString("concentration")%></p>
  <p class="seta">DOB: <%=rs.getString("dob")%></p>
  <p class="seta">Nationality: <%=rs.getString("nationality")%></p>
