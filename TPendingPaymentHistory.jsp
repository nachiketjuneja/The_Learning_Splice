<html>
<head>
	<title>Pending Payments History | The Learning Splice</title>
</head>
...
<tr align=center bgcolor=brown class=setwhite>
    <td class="linktheme"><a href="TutoringRequests.jsp"> Recieved Tutoring Requests </a></td>
</tr>  
<tr align=center bgcolor=brown class=setwhite>
    <td class="linktheme"><a href="TPendingPaymentHistory.jsp"> Pending Payment History </a></td>
</tr>
<tr align=center bgcolor=brown class=setwhite>
    <td class="linktheme"><a href="TApprovedPaymentHistory.jsp"> Approved Payments History <a/></td>
</tr>
<tr align=center bgcolor=brown class=setwhite>
...
<h1 class="setwhite"> These are the payment approval requests that you have received...</h1>

<table border="2" cellpadding="10" cellspacing="10"  class="backcol">
<tr class="rowback">
    <td><b>TRANSACTION ID</b></td>
    <td><b>TUTOR FIRST NAME</b></td>
    <td><b>TUTOR LAST NAME</b></td>
    <td><b>TUTOR USERNAME</b></td>
...
<%
    ...
    String user=(String)session.getAttribute("tusername");
    Class.forName("com.mysql.jdbc.Driver");

    
    
    Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/thelearningsplice","root","root");
            PreparedStatement   st=connection.prepareStatement("select * from spaymenthistory where tusername=?");
            st.setString(1,user);
...
%>
    <tr>
        <td class="setwhite"><%=rs.getString("transactionid") %></td>
    <td class="setwhite"><%=rs.getString("tfirstname") %></td>
    <td class="setwhite"><%=rs.getString("tlastname") %></td>
    <td class="setwhite"><%=rs.getString("tusername") %></td>
    <td class="setwhite"><%=rs.getString("sfirstname") %></td>
    <td class="setwhite"><%=rs.getString("slastname") %></td>
    <td class="setwhite"><%=rs.getString("susername") %></td>
    <td class="setwhite"><%=rs.getString("amount") %></td>
    <td class="setwhite"><%=rs.getString("date") %></td>
...
%>
    ...
    <form action="updatepaymenthistory.jsp">
    ...
    <div class="container">
        ...
        <label for="uname" class="set15"><b>Enter the transaction id that you wish to approve:</b></label><br>
        <input type="text" placeholder="Enter Username" name="tid" required><br>
        <button type="submit" class="set15">Approve</button><br>
    </div>
                </form>
		<hr>
		<br><br>
