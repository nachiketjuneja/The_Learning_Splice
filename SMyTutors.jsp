<html>
<head>
	<title>My Tutors | The Learning Splice</title>
</head>
...
<tr>
<img src="images/trans.png" width="250px" height="250px">
</tr>
<tr align=center bgcolor=brown class=setwhite>
...
<%
   String suname=(String)session.getAttribute("name");
    Class.forName("com.mysql.jdbc.Driver");

    
    
    Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/thelearningsplice","root","root");
            PreparedStatement   st=connection.prepareStatement("select * from mytutors where studentusername=?");
...
<td>
    <div class="card">
  <img src="images/prof.png" alt="John" width="200px" height="200px">
  <h1 class="setorange"><%=rs.getString("firstname")%> <%=rs.getString("lastname")%></h1>
  <p class="title"><%=rs.getString("username")%></p>
  <p class="seth"><b><%=rs.getString("city")%>,<%=rs.getString("nationality")%><b></p>
  <p class="setg">Qualification: <%=rs.getString("qualification")%></p>
  <p class="setg">Subjects Interested: <%=rs.getString("concentration")%></p>
  <p class="setg">DOB: <%=rs.getString("dob")%></p>
  <p class="setg">Contact Number: <%=rs.getString("contactnumber")%></p>
  <p class="setg">E-Mail: <%=rs.getString("email")%></p>
  <p class="setg">Concerned student: <%=rs.getString("studentusername")%></p>
...
%>
    ...
    <h1 class="setorange"><b>PROVIDE RATING TO TUTOR</b></h1>
    <h2 class="setwhite">Providing a rating to your tutor would help him get more students and would build his profile as well.<br>
    A simple step to effectively help your tutor!</h2>
    
    <form action="providerating.jsp">
    

    
    <div class="container">
        
        <label for="tu" class="setwhite"><b>Tutor Username</b></label><br>
        <input type="text" placeholder="Enter Username of Tutor" name="tu" required><br>
        <input type="checkbox" value="verypoor" name="rating">
        <span class="checkboxtext">Very Poor</span><br>
        <input type="checkbox" value="poor" name="rating">
        <span class="checkboxtext">Poor</span><br>
        <input type="checkbox" value="good" name="rating">
        <span class="checkboxtext">Good</span><br>
        <input type="checkbox" value="verygood" name="rating">
        <span class="checkboxtext">Very Good</span><br>
        <input type="checkbox" value="excellent" name="rating">
        <span class="checkboxtext">Excellent</span><br>
         <button type="submit">Provide rating</button><br>
    </div>
    </form>
    	<hr>
	<br><br>
