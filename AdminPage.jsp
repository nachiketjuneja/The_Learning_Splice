<html>
<head>
	<title>Admin Login | The Learning Splice</title>
</head>
...
<form action="checkadmin.jsp">
    <h1 class="seth"><u>ADMIN LOGIN<u></h1><br><br>
   

    
    <div class="container">
        
        <label for="aname" class="set15"><b>Username:</b></label><br>
        <input type="text" placeholder="Enter Username" name="aname" required><br>

        <label for="apsw" class="set15"><b>Password:</b></label><br>
