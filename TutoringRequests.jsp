<html>
<head>
	<title>Tutoring Requests | The Learning Splice</title>
</head>
...
<%
   String tutoruname=(String)session.getAttribute("tusername");
    Class.forName("com.mysql.jdbc.Driver");

    
    
    Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/thelearningsplice","root","root");
            PreparedStatement   st=connection.prepareStatement("select * from contacttutor where tutorusername=?");
         st.setString(1,tutoruname);
...
%>
  ...
  <p class="setg">Concerned tutor: <%=rs.getString("tutorusername")%></p>
  <p class="setg"><%=rs.getString("premium")%></p>
...
%>
    ...
    <br><br>
        ...
        <div id="container">
            <div id="left">
        <form action="approvestudent.jsp">
                <label for="appuser" class="setwhite"><b>Enter the username of the student you wish to accept the request.</b></label><br>
        <input type="text" placeholder="Enter Username" name="appuser" required><br>
        <button type="submit" class="button1" onclick="func()">Approve request</button><br>
        </form>
        </div>
            <div id="middle"></div>
            <div id="right">
                <form action="rejectstudent.jsp">
                <label for="rappuser" class="setwhite"><b>Enter the username of the student you wish to reject the request.</b></label><br>
        <input type="text" placeholder="Enter Username" name="rappuser" required><br>
        <button type="submit" class="button2" onclick="func()">Reject request</button><br>
        </form>
            </div>
        </div>
		<hr>
