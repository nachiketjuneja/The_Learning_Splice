...
<h3> Helping stud   ents help themselves, the fun way!! </h3>
</td>
</tr>
</table>
<table>
...
<br>
<br>
<form action="checksforgotpassword.jsp">
    ...
    <div class="container">
      ...
      <label for="sapass" class="setf"><b> Select the security question:</b></label><br>
      ...
      <input type="password" placeholder="Enter answer to the question" name="ans" required><br>
